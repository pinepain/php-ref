--TEST--
Weak\Reference - compare references ignores notify callbacks
--SKIPIF--
...
$wr1b = new Weak\Reference($obj1, function () {});
$wr2 = new Weak\Reference($obj2, function () {});
$wr3 = new Weak\Reference($obj3, function () {});
